import client1 from "@/assets/landing-page-logos/client1.png";
import client2 from "@/assets/landing-page-logos/client2.png";
import client3 from "@/assets/landing-page-logos/client3.png";
import client4 from "@/assets/landing-page-logos/client4.png";
import client5 from "@/assets/landing-page-logos/client5.png";
...
export const CLIENTS = [
  { alt: "client 1", logo: client1 },
  { alt: "client 2", logo: client2 },
  { alt: "client 3", logo: client3 },
  { alt: "client 4", logo: client4 },
  { alt: "client 5", logo: client5 },
];
