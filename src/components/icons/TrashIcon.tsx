  ...
  return (
    ...
    >
      <path
        ...
        className={`dark:fill-[#2B2939] fill-[#D3D3D3] text-xl transition-all group-hover/native:fill-slate-400`}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        className={`dark:fill-[#817EB5]  fill-[#817EB5] transition-all group-hover/native:fill-[#2B2939]`}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      <path
        ...
        className={`dark:fill-[#817EB5]  fill-[#817EB5] transition-all group-hover/native:fill-[#2B2939] group-hover/native:dark:fill-slate-400`}
      />
    </svg>
  );
};
